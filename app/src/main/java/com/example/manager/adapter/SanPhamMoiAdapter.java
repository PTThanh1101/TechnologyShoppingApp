...
public class SanPhamMoiAdapter extends RecyclerView.Adapter<SanPhamMoiAdapter.MyViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position)
    {
        ...
        holder.txtgia.setText("Prices: "+decimalFormat.format(Double.parseDouble(sanPhamMoi.getGiasp()))+ "Đ");
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnCreateContextMenuListener, View.OnLongClickListener {
        ...
        {
            super(itemView);
            txtgia = itemView.findViewById(R.id.itemspmoi_gia);
            txtten = itemView.findViewById(R.id.itemspmoi_ten);
            imghinhanh = itemView.findViewById(R.id.itemspmoi_image );
        ...
        public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
            contextMenu.add(0,0,getAdapterPosition(),"Alter");
